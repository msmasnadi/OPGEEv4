...
class CsvTemplateCommand(SubcommandABC):
    ...
    def addArgs(self, parser):
        ...
        parser.add_argument('-i', '--include', action='append', default=None,
                            help=clean_help('''Attr colon (":") delimited list of comma-delimited sectors, 
        ...
        parser.add_argument('-s', '--sectors', default=None,
                            help=clean_help('''Attr comma-delimited list of sectors to include in the generated template. Use quotes 
        ...
        parser.add_argument('-r', '--regions', default=None,
                            help=clean_help('''Attr comma-delimited list of regions to include in the generated template. 
        ...
        parser.add_argument('-y', '--years', default='2015-2100',
                            help=clean_help('''Attr hyphen-separated range of timestep years to include in the generated template.
