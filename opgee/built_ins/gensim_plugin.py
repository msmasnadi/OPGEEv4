...
import os
from opgee.config import getParam, setParam, pathjoin
from opgee.log import getLogger
from opgee.utils import mkdirs, getResource
...
def _exportVars(paramFile, args):
    ...
    from opgee.utils import mkdirs
    from opgee.mcs.XMLParameterFile import XMLDistribution, XMLParameterFile
