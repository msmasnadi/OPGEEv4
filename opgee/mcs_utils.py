# Created in 2012 as part of D-MCS
# Imported to pygcam
# Imported to OPGEEv4 23 Mar 2022
#
...
from .error import BaseSpecError, McsUserError, McsSystemError
    ...
    if not _activeYearStrs:
        ...
        def reducer(lst, item):
            ...
            if m:
                ...
                raise McsUserError('Element in list of active years is not an integer: %s' % item)
...
def getOptionalArgs(func):
    ...
    '''
    args, _, _, defaults = inspect.signature(func)
