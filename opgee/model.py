...
class Model(Container):
    ...
    def __init__(self, name, analyses, fields, attr_dict=None):
        ...
        self.diluent_transport_share_fuel = tbl_mgr.get_table("diluent-transport-share-fuel")
        self.LNG_transport_share_fuel = tbl_mgr.get_table("LNG-transport-share-fuel")
        self.crude_transport_share_fuel = tbl_mgr.get_table("crude-transport-share-fuel")

        self.diluent_transport_parameter = tbl_mgr.get_table("diluent-transport-parameter")
        self.LNG_transport_parameter = tbl_mgr.get_table("LNG-transport-parameter")
        self.crude_transport_parameter = tbl_mgr.get_table("crude-transport-parameter")
