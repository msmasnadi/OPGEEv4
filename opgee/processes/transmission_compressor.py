...
class TransmissionCompressor(Process):
    ...
    def run(self, analysis):
        ...
        input.set_temperature_and_pressure(temp=ureg.Quantity(90, "degF"), press=ureg.Quantity(500, "psia"))

        if input.components is None:
            return
        ...
        gas_to_storage.multiply_flow_rates(self.gas_to_storage_frac)
        ...
        gas_to_liquefaction.multiply_flow_rates(self.natural_gas_to_liquefaction_frac)
