...
class TableManager(OpgeeObject):
    ...
    table_defs = [
        ...
        TableDef("diluent-transport-share-fuel", index_col=0, has_units=True),
        TableDef("LNG-transport-share-fuel", index_col=0, has_units=True),
        TableDef("crude-transport-share-fuel", index_col=0, has_units=True),
        TableDef("diluent-transport-parameter", index_col=0),
        TableDef("LNG-transport-parameter", index_col=0),
        TableDef("crude-transport-parameter", index_col=0),
