...
def getTempFile(suffix='', tmpDir=None, text=True, delete=True):
    ...
    :param tmpDir: (str) the directory in which to create the file.
      (Defaults to the value of configuration file variable 'OPGEE.TempDir',
...
def getTempDir(suffix='', tmpDir=None, delete=True):
    ...
    :param tmpDir: (str) the directory in which to create the new temporary
        ...
        'OPGEE.TempDir', or '/tmp' if the variable is not found.
    :param delete: (bool) if False, don't delete the file on cleanup.
       (This is useful for debugging.)
...
class TempFile(object):
    ...
    def __init__(self, path=None, suffix='', tmpDir=None, delete=True,
        ...
        :param tmpDir: (str) the directory in which to create the (defaults to
            the value of configuration file variable 'OPGEE.TempDir', or '/tmp'
        ...
        if path:
            ...
            tmpDir = tmpDir or getParam('OPGEE.TempDir') or "/tmp"
            mkdirs(tmpDir)
    ...
    def deleteFile(self):
        ...
        :return: none
        :raises: OpgeeException if the path is not related to a TempFile instance.
        """
        ...
        try:
            ...
            raise OpgeeException('No TempFile instance with name "%s"' % path)
    ...
    def remove(cls, filename, raiseError=True):
        ...
        try:
            ...
            if raiseError:
                raise OpgeeException('No TempFile instance with name "%s"' % filename)
